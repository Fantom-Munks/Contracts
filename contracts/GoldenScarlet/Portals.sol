...
contract GoldenScarletPortals is ERC721A, IERC2981, AccessControl {
    ...
    string private baseUri = "https://www.munksnft.com/api/golden-scarlet/portals/";
    uint256 public royaltiesPercentage = 7;

    constructor(address[] memory munksStaff)
        ERC721A("FantomMunks PORTALS - Golden Scarlet", "PORTALSGS")
    {
